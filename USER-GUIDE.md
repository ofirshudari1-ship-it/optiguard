...
1. Run `OptiGuard-Setup-4.11.1.exe`. Choose your language on the first screen — this
   sets the language for both the installer and the app.
   הרץ את `OptiGuard-Setup-4.11.1.exe`. בחר שפה במסך הראשון - זה קובע את השפה גם
